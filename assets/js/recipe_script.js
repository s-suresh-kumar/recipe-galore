//******************************************************************************************************************************
// The following code contains a crecipebook with a list of recipes
// Handler functions are added that provide the functionality of:
//
// **loading an initial list of recipes on pageload with createRecipe**
// **adding a new empty recipe to the list with createRecipe**
// **editing any recipe from the list with editRecipe**
// **deleting any recipe from the list with deleteRecipe**
// **updating the list of recipes to localStorage with updateLocalStorage**
//
// This is a prototype for later use.
// I made this in vanilla JS to practice the DOM API a bit more
//******************************************************************************************************************************
(function() {
